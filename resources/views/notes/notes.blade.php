...
{{-- <nav class="nav has-navbar-fixed-top has-text-centered"> --}}
...
<div class="columns is-multiline">
	...
	<div class="column  is-4">
		<div class="card box" draggable="true">
			...
			<footer class="card-footer">
				...
				{{-- <a href="/{{$note->id}}/destroy" class="card-footer-item">Delete</a> --}}
				<form action="/{{$note->id}}/destroy" method="POST" style="background: #f14668;">
					@method('DELETE')
					@csrf
					{{-- {{ method_field('DELETE') }} --}}
					{{-- <a href="/{id}/delete" class="card-footer-item button is-danger">Delete</a> --}}
	...
	<br> <br>
		...
		<div class=" has-background-warning  has-text-centered pl-3">
			...
			<h1 class="title is-1  "> <i class="ff-aparat is-marginless mr-1"></i>No Note Here</h1> 
			<h1 class="title is-1  "> <i class="ff-bale is-marginless mr-1"></i>No Note Here</h1> 
			<h1 class="title is-1  "> <i class="ff-Soroush is-marginless mr-1"></i>No Note Here</h1> 
			{{-- <a class="button is-danger is-centered is-vcentered is-mobile">Create New Note</a> --}}
